...
function view_button(title, key, msg) {
  return Vdom.node("button", /* :: */[
              key ? Vdom.on("click", /* Some */[key[0]], function (ev) {
                      console.log(/* tuple */[
                            "EventKeyed",
                            ev,
                            msg
                      ...
                      return /* Some */[msg];
                    }) : Vdom.on("click", /* None */0, function (ev) {
                      console.log(/* tuple */[
                            "Event",
                            ev,
                            msg
...
function viewEntry(todo) {
  ...
  var props_000$1 = Tea_html.onDoubleClick(/* Some */[key], /* EditingEntry */Block.__(1, [
          todo[/* id */3],
          /* true */1
        ]));
  var props$1 = /* :: */[
...
function visibilitySwap(uri, visibility, actualVisibility) {
  ...
  var props_000$1 = Tea_html.onClick(/* Some */[visibility], /* ChangeVisibility */Block.__(6, [visibility]));
  var props$1 = /* :: */[
    props_000$1,
    /* [] */0
  ];
...
function createElementFromVNode(callbacks, param) {
  if (typeof param === "number") {
    ...
    var child = Web_document.createElementNsOptional(param[0], param[2]);
    return createElementFromVNode_addChildren(callbacks, param[4], applyProperties(callbacks, child, param[3]));
  }
  else {
    var text = param[0];

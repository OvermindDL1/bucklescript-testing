...
function shutdown(model, id) {
  return Tea_cmd.msg(Curry._1(model[/* lift */2], /* Shutdown */Block.__(4, [id])));
}
...
var initModel_000 = /* progress */Tea_http.Progress[/* emptyProgress */0];
...
function update(model, param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          var url = param[0];
          var httpCmd = Tea_http.send(function (param) {
                if (param.tag) {
                  return /* NoOp */0;
                }
                else {
                  return /* GetBookDone */Block.__(2, [
                            url,
                            param[0]
                          ]);
                }
              }, Curry._2(Tea_http.Progress[/* track */1], function (progress) {
                    return /* GetBookProgress */Block.__(1, [
                              url,
                              progress
                            ]);
                  }, Tea_http.getString(url)));
          return /* tuple */[
                  /* record */[
                    /* progress : record */[
                      /* bytes */0,
      ...
      case 1 : 
          if (Caml_obj.caml_notequal(/* Some */[param[0]], model[/* bookUrl */1])) {
            return /* tuple */[
                    model,
                    /* NoCmd */0
                  ];
...
function progressLoaded(progress) {
  var bytes = progress[/* bytes */0];
  var bytesExpected = progress[/* bytesExpected */1];
  if (bytesExpected <= 0.0) {
    return 100;
  }
  else {
    return 100.0 * (bytes / bytesExpected) | 0;
  }
}

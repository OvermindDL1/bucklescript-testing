...
require.register("bs-platform/lib/js/js_json.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "bs-platform");
  (function() {
    'use strict';
...
;require.register("src/main_bookreader.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
function subscriptions(model) {
  var match = model[/* bookUrl */1];
  if (match) {
    var bookUrl = match[0];
    return Curry._3(Tea_http.Progress[/* track */0], bookUrl, function (progress) {
                return /* GetBookProgress */Block.__(1, [progress]);
              }, Tea_http.getString(bookUrl));
  }
  else {
    return /* NoSub */0;
  }
    ...
    if (typeof progress === "number") {
      ...
      switch (progress.tag | 0) {
        case 0 : 
            ...
            break;
        case 1 : 
            var error = progress[0];
            return /* tuple */[
                    /* record */[
                      /* progress : FailProgress */Block.__(1, [error]),
                      /* bookUrl */model[/* bookUrl */1],
                      /* bookContent */Tea_http.string_of_error(error)
                    ],
                    /* NoCmd */0
                  ];
        case 2 : 
            return /* tuple */[
                    /* record */[
                      /* progress : DoneProgress */Block.__(2, [""]),
                      /* bookUrl */model[/* bookUrl */1],
    ...
    if (exit === 1) {
      return /* tuple */[
              /* record */[
                /* progress */progress,
                /* bookUrl */model[/* bookUrl */1],
                /* bookContent */model[/* bookContent */2]
              ],
              /* NoCmd */0
            ];
    }
...
var viewStyle = /* Style */Block.__(4, [/* :: */[
      /* tuple */[
        "display",
        "flex"
      ],
...
var bookTextViewStyle = /* Style */Block.__(4, [/* :: */[
      /* tuple */[
        "height",
        "400px"
      ],
...
function inputRadio(labelText, url) {
  return Tea_html.div(/* None */0, /* None */0, /* [] */0, /* :: */[
              Tea_html.label(/* None */0, /* None */0, /* :: */[
                    Tea_html.onCheck(/* None */0, function (isChecked) {
                          if (isChecked) {
                            return /* GetBook */Block.__(0, [url]);
                          }
                          else {
                            return /* NoOp */0;
                          }
...
function progressView(loaded) {
  return Tea_html.div(/* None */0, /* None */0, /* [] */0, /* :: */[
              ...
              /* :: */[
                Tea_html.progress(/* None */0, /* None */0, /* :: */[
                      /* RawProp */Block.__(0, [
                          "value",
                          loaded
                        ]),
                      /* :: */[
                        Curry._1(Tea_html.Attributes[/* max */0], "100"),
                        /* [] */0
                      ]
                    ], /* :: */[
...
function progressLoaded(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          var match = param[0];
          return Caml_int32.div(Caml_int32.imul(match[/* bytes */0], 100), Caml_int32.imul(match[/* bytesExpected */1], 100));
      case 1 : 
          return 0;
      case 2 : 
          return 100;
...
function bookTextView(valueText) {
  return Tea_html.div(/* None */0, /* None */0, /* [] */0, /* :: */[
              Tea_html.textarea(/* None */0, /* None */0, /* :: */[
                    /* RawProp */Block.__(0, [
                        "value",
                        valueText
                      ]),
...
function view(model) {
  return Tea_html.div(/* None */0, /* None */0, /* :: */[
              ...
              /* :: */[
                ...
                /* :: */[
                  progressView("" + progressLoaded(model[/* progress */0])),
                  /* :: */[
                    bookTextView(model[/* bookContent */2]),
                    /* :: */[
                      footerView,
                      /* [] */0
                    ]
...
exports.update            = update;
exports.viewStyle         = viewStyle;
exports.bookTextViewStyle = bookTextViewStyle;
exports.inputRadio        = inputRadio;
exports.progressView      = progressView;
exports.progressLoaded    = progressLoaded;
exports.footerView        = footerView;
exports.bookTextView      = bookTextView;
exports.view              = view;
exports.main              = main;
/* footerView Not a pure module */

});

;require.register("src/main_clicker.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
var init_mathMod = /* float array */[
  1.0,
  1.0
];

var empty_mathMod = /* float array */[
  0.0,
  1.0
];

function init_upgrade(cost, name, math) {
  return /* record */[
          /* cost */cost,
          /* name */name,
          /* math */math
...
var init_upgrades = List.sort(function (upgradeL, upgradeR) {
      return upgradeL[/* cost */0] - upgradeR[/* cost */0] | 0;
    }, /* :: */[
      /* record */[
        /* cost */10.0,
        /* name */"1 more credit per click",
        /* math : ClickMath */Block.__(0, [/* float array */[
              1.0,
              1.0
            ]])
      ],
      /* :: */[
        /* record */[
          /* cost */50.0,
          /* name */"Half a credit more per click",
          /* math : ClickMath */Block.__(0, [/* float array */[
                0.5,
                1.0
              ]])
        ...
        /* :: */[
          /* record */[
            /* cost */100.0,
            /* name */"50% more credits per click",
            /* math : ClickMath */Block.__(0, [/* float array */[
                  0.0,
                  1.5
                ]])
          ...
          /* :: */[
            /* record */[
              /* cost */150.0,
              /* name */"Finally!  An auto-clicker!",
              /* math : AddAutoClicker */Block.__(1, [/* float array */[
                    1.0,
                    1.0
                  ]])
            ],
            /* :: */[
              ...
              /* :: */[
                /* record */[
                  /* cost */250.0,
                  /* name */"Even 50% more credits per click",
                  /* math : ClickMath */Block.__(0, [/* float array */[
                        0.0,
                        1.5
                      ]])
                ...
                /* :: */[
                  /* record */[
                    /* cost */300.0,
                    /* name */"Get another base half-credit per click please?",
                    /* math : ClickMath */Block.__(0, [/* float array */[
                          0.5,
                          1.0
                        ]])
                  ...
                  /* :: */[
                    /* record */[
                      /* cost */350.0,
                      /* name */"Ooo, double the click value!",
                      /* math : ClickMath */Block.__(0, [/* float array */[
                            0.0,
                            2.0
                          ]])
                    ...
                    /* :: */[
                      ...
                      /* :: */[
                        /* record */[
                          /* cost */500.0,
                          /* name */"Get yet another auto-clicker!",
                          /* math : AddAutoClicker */Block.__(1, [/* float array */[
                                1.0,
                                1.0
                              ]])
                        ...
                        /* :: */[
                          /* record */[
                            /* cost */750.0,
                            /* name */"Upgrade the auto-clickers?",
                            /* math : AddAutoClicker */Block.__(1, [/* float array */[
                                  0.0,
                                  1.5
                                ]])
                          ...
                          /* :: */[
                            /* record */[
                              /* cost */1000.0,
                              /* name */"Get another base half-credit per click",
                              /* math : ClickMath */Block.__(0, [/* float array */[
                                    0.5,
                                    1.0
                                  ]])
                            ...
                            /* :: */[
                              /* record */[
                                /* cost */1250.0,
                                /* name */"Found a way to double output of clicks!",
                                /* math : ClickMath */Block.__(0, [/* float array */[
                                      0.0,
                                      2.0
                                    ]])
                              ...
                              /* :: */[
                                /* record */[
                                  /* cost */1500.0,
                                  /* name */"Upgrade the auto-clickers much more!",
                                  /* math : AddAutoClicker */Block.__(1, [/* float array */[
                                        0.0,
                                        4.0
                                      ]])
                                ...
                                /* :: */[
                                  /* record */[
                                    /* cost */2000.0,
                                    /* name */"Both an additional half credit and another 50% more!",
                                    /* math : ClickMath */Block.__(0, [/* float array */[
                                          0.5,
                                          1.5
                                        ]])
                                  ...
                                  /* :: */[
                                    /* record */[
                                      /* cost */5000.0,
                                      /* name */"Even more 50% more credits per click",
                                      /* math : ClickMath */Block.__(0, [/* float array */[
                                            0.0,
                                            1.5
                                          ]])
                                    ...
                                    /* :: */[
                                      /* record */[
                                        /* cost */10000.0,
                                        /* name */"*2* base credits per click! Wow!",
                                        /* math : ClickMath */Block.__(0, [/* float array */[
                                              2.0,
                                              1.0
                                            ]])
                                      ...
                                      /* :: */[
                                        /* record */[
                                          /* cost */20000.0,
                                          /* name */"Last upgrade! 10x everything!  Please submit PR's with more upgrades and adjust this one to be the last.  ^.^",
                                          /* math : ClickMath */Block.__(0, [/* float array */[
                                                0.0,
                                                10.0
                                              ]])
...
function calc_mathMod_immediate(initial, math) {
  return (initial + math[/* baseAdd */0]) * math[/* mult */1];
}

function calc_mathMod_combine(math1, math2) {
  return /* float array */[
          math1[/* baseAdd */0] + math2[/* baseAdd */0],
          math1[/* mult */1] * math2[/* mult */1]
        ];
}

var worthString = Pervasives.string_of_float

function calcWorth_click(math) {
  return calc_mathMod_immediate(0.000, math);
}

function applyUpgrade(name, model) {
  var model$1 = model;
  var _untouched = /* [] */0;
  var _param = model[/* upgradesRemaining */5];
  while(true) {
    var param = _param;
    ...
    if (param) {
      ...
      else if (upgrade[/* cost */0] > model$1[/* credits */3]) {
        return model$1;
      }
      else {
        var match = upgrade[/* math */2];
        var newModel;
        newModel = match.tag ? /* record */[
            /* startTime */model$1[/* startTime */0],
            /* curTime */model$1[/* curTime */1],
            /* lastUpdated */model$1[/* lastUpdated */2],
            /* credits */model$1[/* credits */3] - upgrade[/* cost */0],
            /* clickWorthMath */model$1[/* clickWorthMath */4],
            /* upgradesRemaining */model$1[/* upgradesRemaining */5],
            /* upgradesUsed */model$1[/* upgradesUsed */6] + 1 | 0,
            /* messages : :: */[
              "Bought " + (upgrade[/* name */1] + (" for " + (Pervasives.string_of_float(upgrade[/* cost */0]) + " credits"))),
              model$1[/* messages */7]
            ],
            /* autoClicker */calc_mathMod_combine(model$1[/* autoClicker */8], match[0])
          ] : /* record */[
            /* startTime */model$1[/* startTime */0],
            /* curTime */model$1[/* curTime */1],
            /* lastUpdated */model$1[/* lastUpdated */2],
            /* credits */model$1[/* credits */3] - upgrade[/* cost */0],
            /* clickWorthMath */calc_mathMod_combine(model$1[/* clickWorthMath */4], match[0]),
            /* upgradesRemaining */model$1[/* upgradesRemaining */5],
            /* upgradesUsed */model$1[/* upgradesUsed */6] + 1 | 0,
            /* messages : :: */[
              "Bought " + (upgrade[/* name */1] + (" for " + (Pervasives.string_of_float(upgrade[/* cost */0]) + " credits"))),
            ...
            /* autoClicker */model$1[/* autoClicker */8]
          ];
        var newrecord = newModel.slice();
        newrecord[/* upgradesRemaining */5] = List.append(List.rev(untouched), rest);
        return newrecord;
      }
    }
    else {
      var newrecord$1 = model$1.slice();
      newrecord$1[/* upgradesRemaining */5] = List.rev(untouched);
      return newrecord$1;
    }
  };
}
...
function update(model, param) {
  if (typeof param === "number") {
    ...
    return /* tuple */[
            (newrecord[/* credits */3] = model[/* credits */3] + calc_mathMod_immediate(0.000, model[/* clickWorthMath */4]), newrecord),
            /* NoCmd */0
          ];
  }
  else if (param.tag) {
    return /* tuple */[
            applyUpgrade(param[0], model),
            /* NoCmd */0
          ];
  }
  else {
    ...
    return /* tuple */[
            /* record */[
              /* startTime */model[/* startTime */0] < 1.0 ? ev[/* time */0] : model[/* startTime */0],
              /* curTime */ev[/* time */0],
              /* lastUpdated */model[/* lastUpdated */2],
              /* credits */model[/* credits */3] + ev[/* delta */1] * 0.001 * calc_mathMod_immediate(0.000, model[/* clickWorthMath */4]) * model[/* autoClicker */8][/* mult */1] * model[/* autoClicker */8][/* baseAdd */0],
              /* clickWorthMath */model[/* clickWorthMath */4],
              /* upgradesRemaining */model[/* upgradesRemaining */5],
              /* upgradesUsed */model[/* upgradesUsed */6],
              /* messages */model[/* messages */7],
              /* autoClicker */model[/* autoClicker */8]
            ],
            /* NoCmd */0
          ];
  }
...
function subscriptions(model) {
  if (model[/* autoClicker */8][/* baseAdd */0] > 0.0 || model[/* startTime */0] < 1.0) {
    return Tea_animationframe.every(/* None */0, function (ev) {
                return /* OnFrame */Block.__(0, [ev]);
              });
  }
  else {
    return /* NoSub */0;
...
var css_container_top = /* Style */Block.__(4, [/* :: */[
      /* tuple */[
        "width",
        "100%"
      ],
...
var css_container_bot = /* Style */Block.__(4, [/* :: */[
      /* tuple */[
        "width",
        "100%"
      ],
...
var css_container_center = /* Style */Block.__(4, [/* :: */[
      /* tuple */[
        "width",
        "100%"
      ],
...
function view_topBar(model) {
  return Tea_html.tr(/* None */0, /* None */0, /* :: */[
              css_container_top,
              /* [] */0
            ], /* :: */[
...
function view_upgrades(model, param) {
  if (param) {
    var upgrade = param[0];
    if (model[/* credits */3] >= upgrade[/* cost */0]) {
      return /* :: */[
              Tea_html.button(/* Some */[upgrade[/* name */1]], /* None */0, /* :: */[
...
function view(model) {
  return Tea_html.table(/* None */0, /* None */0, /* :: */[
              css_topContainer,
              /* [] */0
            ], /* :: */[
              Tea_html.tbody(/* None */0, /* None */0, /* [] */0, /* :: */[
                    view_topBar(model),
                    /* :: */[
                      view_center(model),
                      /* :: */[
...
var baseWorth_click = 0.000;

exports.mathMod                = mathMod;
exports.init_mathMod           = init_mathMod;
exports.empty_mathMod          = empty_mathMod;
exports.init_upgrade           = init_upgrade;
exports.init_upgrades          = init_upgrades;
exports.init                   = init;
exports.calc_mathMod_immediate = calc_mathMod_immediate;
exports.calc_mathMod_combine   = calc_mathMod_combine;
exports.worthString            = worthString;
exports.baseWorth_click        = baseWorth_click;
exports.calcWorth_click        = calcWorth_click;
exports.applyUpgrade           = applyUpgrade;
exports.update                 = update;
exports.subscriptions          = subscriptions;
exports.worthStringText        = worthStringText;
exports.css_topContainer       = css_topContainer;
exports.styles_container       = styles_container;
exports.css_container_top      = css_container_top;
exports.css_container_bot      = css_container_bot;
exports.css_container_center   = css_container_center;
exports.view_topBar            = view_topBar;
exports.view_botBar            = view_botBar;
exports.view_upgrades          = view_upgrades;
exports.view_center            = view_center;
exports.view                   = view;
exports.main                   = main;
/* init_upgrades Not a pure module */
...
function subscriptions() {
  return Tea_time.every(16.0, function (t) {
              return /* Time */[t];
            });
}
...
function subscriptions() {
  return Tea_time.every(Tea_time.second, function (t) {
              return /* Time */[t];
            });
}
...
;require.register("src/main_json.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
function view(jsonString) {
  var decoder = Curry._1(Tea_json.Decoder[/* keyValuePairs */9], Tea_json.Decoder[/* string */2]);
  var kvPairsResult = Curry._2(Tea_json.Decoder[/* decodeString */31], decoder, jsonString);
  var reEncoded;
  if (kvPairsResult.tag) {
    reEncoded = "";
  }
  else {
    var encoded = Curry._1(Tea_json.Encoder[/* object_ */6], List.map(function (param) {
              return /* tuple */[
                      param[0],
                      Curry._1(Tea_json.Encoder[/* string */1], param[1])
                    ];
            }, kvPairsResult[0]));
    reEncoded = Curry._2(Tea_json.Encoder[/* encode */0], 2, encoded);
  }
  var encoded$1 = Curry._1(Tea_json.Encoder[/* object_ */6], /* :: */[
        /* tuple */[
          "string",
          Curry._1(Tea_json.Encoder[/* string */1], "a string")
        ],
        /* :: */[
          /* tuple */[
            "int",
            Curry._1(Tea_json.Encoder[/* int */2], 42)
          ],
          /* :: */[
            /* tuple */[
              "float",
              Curry._1(Tea_json.Encoder[/* float */3], 3.14)
            ],
            /* :: */[
              /* tuple */[
                "object",
                Curry._1(Tea_json.Encoder[/* object_ */6], /* :: */[
                      /* tuple */[
                        "sub",
                        Curry._1(Tea_json.Encoder[/* string */1], "object")
                      ],
                      /* [] */0
                    ])
              ],
              /* :: */[
                /* tuple */[
                  "array",
                  Curry._1(Tea_json.Encoder[/* array */7], /* array */[
                        Curry._1(Tea_json.Encoder[/* int */2], 1),
                        Curry._1(Tea_json.Encoder[/* string */1], "2")
                      ])
                ],
                /* :: */[
                  /* tuple */[
                    "list",
                    Curry._1(Tea_json.Encoder[/* list */8], /* :: */[
                          Curry._1(Tea_json.Encoder[/* int */2], 1),
                          /* :: */[
                            Curry._1(Tea_json.Encoder[/* string */1], "2"),
                            /* [] */0
                  ...
                  /* :: */[
                    /* tuple */[
                      "boolean",
                      Curry._1(Tea_json.Encoder[/* bool */4], /* true */1)
                    ],
                    /* :: */[
                      /* tuple */[
                        "null",
                        Tea_json.Encoder[/* null */5]
                      ],
                      /* [] */0
                    ]
                  ]
  ...
  var newEncoded = Curry._2(Tea_json.Encoder[/* encode */0], 2, encoded$1);
  var mapper = function (s, i, f, os, a0, l1, b, n) {
  ...
  var decoder$1 = Curry.app(Tea_json.Decoder[/* map8 */23], [
        mapper,
        Curry._2(Tea_json.Decoder[/* field */11], "string", Tea_json.Decoder[/* string */2]),
        Curry._2(Tea_json.Decoder[/* field */11], "int", Tea_json.Decoder[/* int */3]),
        Curry._2(Tea_json.Decoder[/* field */11], "float", Tea_json.Decoder[/* float */4]),
        Curry._2(Tea_json.Decoder[/* at */12], /* :: */[
              "object",
              /* :: */[
                "sub",
                /* [] */0
        ...
        Curry._2(Tea_json.Decoder[/* field */11], "array", Curry._2(Tea_json.Decoder[/* index */13], 0, Tea_json.Decoder[/* int */3])),
        Curry._2(Tea_json.Decoder[/* field */11], "list", Curry._2(Tea_json.Decoder[/* index */13], 1, Tea_json.Decoder[/* string */2])),
        Curry._2(Tea_json.Decoder[/* field */11], "boolean", Tea_json.Decoder[/* bool */5]),
        Curry._2(Tea_json.Decoder[/* field */11], "null", Curry._1(Tea_json.Decoder[/* null */6], "null"))
      ]);
  var newReEncoded = Curry._2(Tea_json.Decoder[/* decodeString */31], decoder$1, newEncoded);
  var newReEncodedString;
  ...
  return Tea_html.div(/* None */0, /* None */0, /* [] */0, /* :: */[
              Tea_html.textarea(/* None */0, /* None */0, /* :: */[
                    /* RawProp */Block.__(0, [
                        "placeholder",
                        "Put JSON string here that fullfills being an object of strings"
                      ]),
                    /* :: */[
                      Tea_html.onInput(/* None */0, function (a) {
                            return /* NewContent */[a];
                          }),
                      /* :: */[
                        myStyle,
...
;require.register("src/main_todo_optimizedmap.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
function update(model, param) {
  if (typeof param === "number") {
    if (param) {
      return /* tuple */[
              /* record */[
                /* entries */filter(function (_, param) {
                      return !param[/* completed */1];
                    }, model[/* entries */0]),
                /* field */model[/* field */1],
                /* uid */model[/* uid */2],
      ...
      return /* tuple */[
              /* record */[
                /* entries */model[/* field */1] === "" ? model[/* entries */0] : add(model[/* uid */2], newEntry(model[/* field */1], model[/* uid */2]), model[/* entries */0]),
                /* field */"",
                /* uid */model[/* uid */2] + 1 | 0,
                /* visibility */model[/* visibility */3]
              ],
    ...
    switch (param.tag | 0) {
      ...
      case 1 : 
          ...
          return /* tuple */[
                  /* record */[
                    /* entries */mem(id, model[/* entries */0]) ? add(id, updateEntry(find(id, model[/* entries */0])), model[/* entries */0]) : model[/* entries */0],
                    /* field */model[/* field */1],
                    /* uid */model[/* uid */2],
                    /* visibility */model[/* visibility */3]
                  ],
      ...
      case 2 : 
          ...
          return /* tuple */[
                  /* record */[
                    /* entries */mem(id$1, model[/* entries */0]) ? add(id$1, updateEntry$1(find(id$1, model[/* entries */0])), model[/* entries */0]) : model[/* entries */0],
                    /* field */model[/* field */1],
                    /* uid */model[/* uid */2],
                    /* visibility */model[/* visibility */3]
                  ],
      ...
      case 3 : 
          return /* tuple */[
                  /* record */[
                    /* entries */remove(param[0], model[/* entries */0]),
                    /* field */model[/* field */1],
                    /* uid */model[/* uid */2],
                    /* visibility */model[/* visibility */3]
                  ],
      ...
      case 4 : 
          ...
          return /* tuple */[
                  /* record */[
                    /* entries */mem(id$2, model[/* entries */0]) ? add(id$2, updateEntry$2(find(id$2, model[/* entries */0])), model[/* entries */0]) : model[/* entries */0],
                    /* field */model[/* field */1],
                    /* uid */model[/* uid */2],
                    /* visibility */model[/* visibility */3]
                  ],
      ...
      case 5 : 
          ...
          return /* tuple */[
                  /* record */[
                    /* entries */map(updateEntry$3, model[/* entries */0]),
                    /* field */model[/* field */1],
                    /* uid */model[/* uid */2],
                    /* visibility */model[/* visibility */3]
                  ],
...
function viewEntries(visibility, entries) {
  ...
  var allCompleted = for_all(function (_, param) {
        return param[/* completed */1];
      }, entries);
  var cssVisibility = (
    entries ? /* false */0 : /* true */1
  ) ? "hidden" : "visible";
  return Tea_html.section(/* None */0, /* None */0, /* :: */[
              /* RawProp */Block.__(0, [
                  "className",
...
function viewControls(visibility, entries) {
  var entriesCompleted = fold(function (_, param, c) {
        if (param[/* completed */1]) {
          return c + 1 | 0;
        }
        else {
  ...
  var len = cardinal(entries);
  var entriesLeft = len - entriesCompleted | 0;
  return Tea_html.footer(/* None */0, /* None */0, /* :: */[
              /* RawProp */Block.__(0, [
                  "className",
                  "footer"
...
;require.register("src/tea_animationframe.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
;require.register("src/tea_http.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
function string_of_error(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case 2 : 
          return "Bad Payload: " + param[0][/* url */0];
...
function send(resultToMessage, param) {
  ...
  var typ = request[/* expect */4][0];
  return /* EnqueueCall */Block.__(2, [function (enqueue) {
              var xhr = new XMLHttpRequest();
              if (maybeEvents) {
                var match = maybeEvents[0];
                var may = function (thenDo, param) {
                  if (param) {
                    return Curry._1(thenDo, param[0]);
                  }
                  else {
                    return /* () */0;
                  }
              ...
              var cb = function () {
                return Curry._1(enqueue, Curry._1(resultToMessage, /* NetworkError */1));
              };
              xhr.onerror = cb;
              var cb$1 = function () {
                return Curry._1(enqueue, Curry._1(resultToMessage, /* Timeout */0));
              };
              xhr.ontimeout = cb$1;
              var cb$2 = function () {
                return Curry._1(enqueue, Curry._1(resultToMessage, /* Aborted */2));
              };
              xhr.onabort = cb$2;
              var cb$3 = function () {
                ...
                /* record */[
                  ...
                  /* headers */headers,
                  /* body */Web_xmlhttprequest.get_response(xhr)
                ];
                return /* () */0;
              };
              xhr.onload = cb$3;
              try {
                ...
                Curry._1(enqueue, Curry._1(resultToMessage, /* BadUrl */Block.__(0, [url])));
              }
...
function track(id, _, _$1) {
  ...
  return Tea_sub.registration(id, enableCall);
}

var Progress = /* module */[/* track */track];
...
;require.register("src/tea_json.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
;require.register("src/tea_result.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
  ...
  return /* EnqueueCall */Block.__(2, [function (enqueue) {
              return Curry._1(task, function (param) {
                          if (param.tag) {
                            throw [
                                  Caml_builtin_exceptions.failure,
                                  "ERROR:  Task perfom was called with an error of never!"
                                ];
                          }
                          else {
                            return Curry._1(enqueue, Curry._1(toOptionalMessage, param[0]));
                          }
                        });
            }]);
}
...
function attemptOpt(resultToOptionalMessage, param) {
  ...
  return /* EnqueueCall */Block.__(2, [function (enqueue) {
              return Curry._1(task, function (value) {
                          return Curry._1(enqueue, Curry._1(resultToOptionalMessage, value));
                        });
            }]);
}
...
;require.register("src/web_formdata.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
;require.register("src/web_json.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';
...
;require.register("src/web_xmlhttprequest.ml", function(exports, require, module) {
// Generated by BUCKLESCRIPT VERSION 1.2.1 , PLEASE EDIT WITH CARE
'use strict';

...
function viewEntry(todo) {
  var props_000 = /* RawProp */Block.__(0, [
      "className",
      "toggle"
    ]);
  var props_001 = /* :: */[
    ...
    /* :: */[
      ...
      /* :: */[
        Tea_html.onClick(/* Check */Block.__(4, [
                todo[/* id */3],
                !todo[/* completed */1]
              ])),
        /* [] */0
  ...
  var nodes_000 = /* Text */Block.__(0, [todo[/* description */0]]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  var props_000$1 = Tea_html.onDoubleClick(/* EditingEntry */Block.__(1, [
          todo[/* id */3],
          /* true */1
        ]));
  var props$1 = /* :: */[
  ...
  var props_000$2 = /* RawProp */Block.__(0, [
      "className",
      "destroy"
    ]);
  var props_001$1 = /* :: */[
    Tea_html.onClick(/* Delete */Block.__(3, [todo[/* id */3]])),
    /* [] */0
  ];
  var props$2 = /* :: */[
    props_000$2,
  ...
  var nodes_000$1 = Vdom.node("input", props, /* [] */0);
  var nodes_001 = /* :: */[
    Vdom.node("label", props$1, nodes),
    /* :: */[
      Vdom.node("button", props$2, /* [] */0),
      /* [] */0
    ]
  ];
  var nodes$1 = /* :: */[
  ...
  var props_000$3 = /* RawProp */Block.__(0, [
      "className",
      "view"
    ]);
  var props$3 = /* :: */[
  ...
  var props_000$4 = /* RawProp */Block.__(0, [
      "className",
      "edit"
    ]);
  var props_001$2 = /* :: */[
    ...
    /* :: */[
      ...
      /* :: */[
        ...
        /* :: */[
          Tea_html.onInput(function (value) {
          ...
          /* :: */[
            Tea_html.onBlur(/* EditingEntry */Block.__(1, [
                    todo[/* id */3],
                    /* false */0
                  ])),
            /* :: */[
              onEnter(/* EditingEntry */Block.__(1, [
                      todo[/* id */3],
                      /* false */0
                    ])),
              /* [] */0
  ...
  var nodes_000$2 = Vdom.node("div", props$3, nodes$1);
  var nodes_001$1 = /* :: */[
    Vdom.node("input", props$4, /* [] */0),
    /* [] */0
  ];
  var nodes$2 = /* :: */[
    nodes_000$2,
  ...
  var props_000$5 = Tea_html.classList(/* :: */[
        /* tuple */[
          "completed",
          todo[/* completed */1]
        ],
  ...
  return Vdom.node("li", props$5, nodes$2);
}
...
function viewEntries(visibility, entries) {
  ...
  var props_001 = /* :: */[
    ...
    /* :: */[
      ...
      /* :: */[
        ...
        /* :: */[
          Tea_html.onClick(/* CheckAll */Block.__(5, [!allCompleted])),
          /* [] */0
        ]
      ]
    ]
  ...
  var nodes_000 = /* Text */Block.__(0, ["Mark all as complete"]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  var props_000$1 = /* RawProp */Block.__(0, [
      "for",
      "toggle-all"
    ]);
  var props$1 = /* :: */[
  ...
  var nodes$1 = List.map(viewEntry, List.filter(isVisible)(entries));
  var props_000$2 = /* RawProp */Block.__(0, [
      "className",
      "todo-list"
    ]);
  ...
  return Vdom.node("section", props$3, nodes$2);
}

function viewInput(task) {
  var nodes_000 = /* Text */Block.__(0, ["todos"]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  ...
  var nodes_000$1 = Vdom.node("h1", /* [] */0, nodes);
  var nodes_001 = /* :: */[
    Vdom.node("input", props, /* [] */0),
    /* [] */0
  ];
  var nodes$1 = /* :: */[
    nodes_000$1,
  ...
  return Vdom.node("header", props$1, nodes$1);
}

function viewControlsCount(entriesLeft) {
  var item_ = entriesLeft === 1 ? " item" : " items";
  var nodes_000 = /* Text */Block.__(0, ["" + entriesLeft]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  var nodes_000$1 = Vdom.node("strong", /* [] */0, nodes);
  var nodes_001 = /* :: */[
  ...
  return Vdom.node("span", props, nodes$1);
}

function visibilitySwap(uri, visibility, actualVisibility) {
  var nodes_000 = /* Text */Block.__(0, [visibility]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  ...
  var nodes_000$1 = Vdom.node("a", props, nodes);
  var nodes$1 = /* :: */[
    nodes_000$1,
    /* [] */0
  ];
  var props_000$1 = Tea_html.onClick(/* ChangeVisibility */Block.__(6, [visibility]));
  var props$1 = /* :: */[
    props_000$1,
    /* [] */0
  ];
  return Vdom.node("li", props$1, nodes$1);
}

function viewControlsFilters(visibility) {
  var nodes_000 = visibilitySwap("#/", "All", visibility);
  var nodes_001 = /* :: */[
    /* Text */Block.__(0, [" "]),
    /* :: */[
  ...
  return Vdom.node("ul", props, nodes);
}

function viewControlsClear(entriesCompleted) {
  var nodes_000 = /* Text */Block.__(0, ["Clear completed (" + (entriesCompleted + ")")]);
  var nodes = /* :: */[
    nodes_000,
    /* [] */0
  ];
  ...
  var props_001 = /* :: */[
    ...
    /* :: */[
      Tea_html.onClick(/* DeleteComplete */2),
      /* [] */0
    ]
  ];
  var props = /* :: */[
  ...
  return Vdom.node("button", props, nodes);
}
...
function viewControls(visibility, entries) {
  ...
  var nodes_000 = viewControlsCount(entriesLeft);
  var nodes_001 = /* :: */[
  ...
  return Vdom.node("footer", props, nodes);
}

var nodes_000 = /* Text */Block.__(0, ["Double-click to edit a todo"]);
...
var nodes_000$1 = /* Text */Block.__(0, ["Evan Czaplicki"]);
...
var nodes_000$2 = /* Text */Block.__(0, ["OvermindDL1"]);
...
var nodes_000$3 = /* Text */Block.__(0, ["Written by "]);

var nodes_001 = /* :: */[
  Vdom.node("a", props, nodes$1),
  /* :: */[
    /* Text */Block.__(0, [" and "]),
    /* :: */[
      Vdom.node("a", props$1, nodes$2),
      /* [] */0
    ]
  ]
];
...
var nodes_000$4 = /* Text */Block.__(0, ["TodoMVC"]);
...
var nodes_000$5 = /* Text */Block.__(0, ["Part of "]);

var nodes_001$1 = /* :: */[
  Vdom.node("a", props$2, nodes$4),
  /* [] */0
];
...
var nodes_000$6 = Vdom.node("p", /* [] */0, nodes);

var nodes_001$2 = /* :: */[
  Vdom.node("p", /* [] */0, nodes$3),
  /* :: */[
    Vdom.node("p", /* [] */0, nodes$5),
    /* [] */0
  ]
];
...
var infoFooter = Vdom.node("footer", props$3, nodes$6);

function view(model) {
  var nodes_000 = viewInput(model[/* field */1]);
  var nodes_001 = /* :: */[
  ...
  var nodes_000$1 = Vdom.node("section", props, nodes);
  var nodes_001$1 = /* :: */[
    infoFooter,
    /* [] */0
  ];
  ...
  return Vdom.node("div", props$1, nodes$1);
}
...
function programLoop(update, view, initModel, param) {
  if (param) {
    ...
    return function (callbacks) {
      ...
      Vdom.patchVNodesIntoElement(callbacks, parentNode, /* [] */0, lastVdom[0]);
...
function program(param, pnode, flags) {
  ...
  return programStateWrapper(initModel, pump);
}
...
function div(props, nodes) {
  return Vdom.node("div", props, nodes);
}

function span(props, nodes) {
  return Vdom.node("span", props, nodes);
}

function p(props, nodes) {
  return Vdom.node("p", props, nodes);
}

function a(props, nodes) {
  return Vdom.node("a", props, nodes);
}

function section(props, nodes) {
  return Vdom.node("section", props, nodes);
}

function header(props, nodes) {
  return Vdom.node("header", props, nodes);
}

function footer(props, nodes) {
  return Vdom.node("footer", props, nodes);
}

function h1(props, nodes) {
  return Vdom.node("h1", props, nodes);
}

function strong(props, nodes) {
  return Vdom.node("strong", props, nodes);
}

function button(props, nodes) {
  return Vdom.node("button", props, nodes);
}

function input(props, nodes) {
  return Vdom.node("input", props, nodes);
}

function label(props, nodes) {
  return Vdom.node("label", props, nodes);
}

function ul(props, nodes) {
  return Vdom.node("ul", props, nodes);
}

function ol(props, nodes) {
  return Vdom.node("ol", props, nodes);
}

function li(props, nodes) {
  return Vdom.node("li", props, nodes);
}
...
function _eventGetTargetValue(ev) {
  var match = ev.target;
  if (match !== undefined) {
    v$1 = match.value;
    if (v$1 === undefined) {
...
function onInput(msg) {
  return /* Event */Block.__(3, [
            ...
            "",
            function () {
              return /* Some */[Curry._1(msg, "Testering")];
            }
          ]);
}
...
exports.on                   = on;
exports._eventGetTarget      = _eventGetTarget;
exports._eventGetTargetValue = _eventGetTargetValue;
    ...
    if (oldVNodes) {
      ...
      if (newVNodes) {
        if (typeof oldVnode === "number") {
          ...
          if (typeof match === "number") {
            ...
            if (oldVnode[0] !== match[0] || oldVnode[1] !== match[1] || oldVnode[2] !== match[2]) {
              _newVNodes = newRest;
              _oldVNodes = oldRest;
              _idx = idx + 1 | 0;
              continue ;
              ...
              patchVNodesOnElems_Properties(callbacks, child, oldVnode[3], match[3]);
              patchVNodesOnElems(callbacks, child, childChildren, 0, oldVnode[4], match[4]);
              _newVNodes = newRest;
              _oldVNodes = oldRest;
              _idx = idx + 1 | 0;
              continue ;
      ...
      if (exit === 1) {
        ...
        if (typeof match$2 === "number") {
          ...
          Web_node.insertBefore(elem, newChild, child$3);
          ...
          var newChild$1 = patchVNodesOnElems_createElement(callbacks, match$2[0], match$2[2], match$2[3]);
          var childChildren$1 = newChild$1.childNodes;
          patchVNodesOnElems(callbacks, newChild$1, childChildren$1, 0, /* [] */0, match$2[4]);
          Web_node.insertBefore(elem, newChild$1, child$4);
          ...
          var newChild$2 = document.createTextNode(match$2[0]);
          Web_node.insertBefore(elem, newChild$2, child$5);
      ...
      if (typeof match$3 === "number") {
        ...
        var newChild$4 = patchVNodesOnElems_createElement(callbacks, match$3[0], match$3[2], match$3[3]);
        var childChildren$2 = newChild$4.childNodes;
        patchVNodesOnElems(callbacks, newChild$4, childChildren$2, 0, /* [] */0, match$3[4]);
        ...
        var newChild$5 = document.createTextNode(match$3[0]);

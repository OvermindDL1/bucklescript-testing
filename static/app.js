...
var string = /* Decoder */[function (value) {
    var match = Js_json.reify_type(value);
    if (match[0] !== 0) {
...
function map$1(mapper, param) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._1(mapper, match[0]);
            }
          }];
}
...
function map2(mapper, param, param$1) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._2(mapper, match[0], match$1[0]);
            }
          }];
}
...
function map3(mapper, param, param$1, param$2) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._3(mapper, match[0], match$1[0], match$2[0]);
            }
          }];
}
...
function map4(mapper, param, param$1, param$2, param$3) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._4(mapper, match[0], match$1[0], match$2[0], match$3[0]);
            }
          }];
}
...
function map5(mapper, param, param$1, param$2, param$3, param$4) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._5(mapper, match[0], match$1[0], match$2[0], match$3[0], match$4[0]);
            }
          }];
}
...
function map6(mapper, param, param$1, param$2, param$3, param$4, param$5) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._6(mapper, match[0], match$1[0], match$2[0], match$3[0], match$4[0], match$5[0]);
            }
          }];
}
...
function map7(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._7(mapper, match[0], match$1[0], match$2[0], match$3[0], match$4[0], match$5[0], match$6[0]);
            }
          }];
}
...
function map8(mapper, param, param$1, param$2, param$3, param$4, param$5, param$6, param$7) {
  ...
  return /* Decoder */[function (value) {
            ...
            if (match.tag) {
              ...
              return Curry._8(mapper, match[0], match$1[0], match$2[0], match$3[0], match$4[0], match$5[0], match$6[0], match$7[0]);
            }
          }];
}
...
function decodeString(decoder, string) {
  try {
    ...
    return /* Error */Block.__(1, ["Given an invalid JSON string"]);
  }
}
